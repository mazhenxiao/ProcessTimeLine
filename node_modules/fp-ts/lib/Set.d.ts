 ...
 * @since 1.2.0
 */
export declare const map: <B>(bset: Setoid<B>) => <A>(x: Set<A>, f: (x: A) => B) => Set<B>;
/**
 * @function
 * @since 1.0.0
 */
 ...
 * @since 1.2.0
 */
export declare const chain: <B>(bset: Setoid<B>) => <A>(x: Set<A>, f: (x: A) => Set<B>) => Set<B>;
/**
 ...
 * @since 1.0.0
 */
export declare const filter: <A>(x: Set<A>, predicate: Predicate<A>) => Set<A>;
/**
 * @function
 * @since 1.2.0
 */
export declare const partition: <A>(x: Set<A>, predicate: Predicate<A>) => {
    right: Set<A>;
    left: Set<A>;
};
/**
 ...
 * @since 1.2.0
 */
export declare const partitionMap: <A, L, R>(x: Set<A>, f: (a: A) => Either<L, R>) => {
    left: Set<L>;
    right: Set<R>;
};
/**
