...
var traverse = function (F) {
    var traverseAF = Array_1.traverse(F);
    var treeLifted = Apply_1.liftA2(F)(function (value) { return function (forest) { return new Tree(value, forest); }; });
    var r = function (ta, f) {
        return treeLifted(f(ta.value))(traverseAF(ta.forest, function (t) { return r(t, f); }));
    };
    return r;
};
/**
...
function unfoldForestM(M) {
    var traverseAM = Array_1.traverse(M);
    var unfoldTreeMM;
    return function (bs, f) {
        ...
        return traverseAM(bs, function (b) { return unfoldTreeMM(b, f); });
    };
}
